...
void Args::parseArgs(const std::vector<std::string>& args) {
  ...
  } else if (command == "c2v-top") {
    model = model_name::c2v_t;
  } else if (command == "c2v-intra") {
    model = model_name::c2v_a;
  } else if (command == "c2v-inter") {
    model = model_name::c2v_c;
  } else if (command == "c2v-hybrid") {
    model = model_name::c2v_h;
  }
