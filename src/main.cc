...
void printUsage() {
  std::cerr
      ...
      << "  c2v-intra               train a confusion2vec-intra model\n"
      << "  c2v-inter               train a confusion2vec-inter model\n"
      << "  c2v-top                 train a confusion2vec-top model\n"
      << "  c2v-hybrid              train a confusion2vec-hybrid model\n"
...
int main(int argc, char** argv) {
  ...
  if (command == "skipgram" || command == "cbow" || command == "supervised" || command == "c2v-top" || command == "c2v-intra" || command == "c2v-inter" || command == "c2v-hybrid") {
    train(args);
