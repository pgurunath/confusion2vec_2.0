...
class FastText {
 ...
 protected:
  ...
  void interconfusion(Model::State& state, real lr, const std::vector<std::vector<int32_t>>& sausage);
  void intraconfusion(Model::State& state, real lr, const std::vector<std::vector<int32_t>>& sausage);
  void topconfusion(Model::State& state, real lr, const std::vector<std::vector<int32_t>>& sausage);
  void hybridconfusion(Model::State& state, real lr, const std::vector<std::vector<int32_t>>& sausage);
 ...
 public:
  ...
  std::string modelToString(model_name mn) const;
};
} // namespace fasttext
